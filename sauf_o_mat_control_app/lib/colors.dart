...
final ThemeData appTheme = ThemeData(
  ...
  appBarTheme: const AppBarTheme(
    ...
    elevation: 2,
    titleTextStyle: TextStyle(fontFamily: 'Georgia', fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),
  ),
  ...
  scrollbarTheme: ScrollbarThemeData(
    thumbColor: WidgetStateProperty.all(Color(0xFF8B4513)),
    trackColor: WidgetStateProperty.all(Color(0xFFF4A460)),
    thickness: WidgetStateProperty.all(6),
    radius: const Radius.circular(8),
  ),
  textTheme: TextTheme(
    headlineSmall: const TextStyle(color: Color(0xFF8B4513), fontWeight: FontWeight.bold, fontFamily: 'Georgia'),
    titleLarge: TextStyle(color: Colors.brown.shade800, fontSize: 60),
    titleMedium: TextStyle(color: Colors.brown.shade800, fontFamily: 'Georgia'),
    bodyMedium: TextStyle(color: Colors.brown.shade900, fontFamily: 'Georgia'),
    bodyLarge: TextStyle(color: Colors.brown.shade900, fontFamily: 'Georgia'),
  ),
);
